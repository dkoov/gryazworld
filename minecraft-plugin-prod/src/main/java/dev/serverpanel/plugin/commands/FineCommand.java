...
implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args2) {
        ...
        if (args2.length < 4) {
            sender.sendMessage(this.plugin.prefix() + "\u00a7c\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0435: \u00a7f/fine <\u0438\u0433\u0440\u043e\u043a> <\u0441\u0443\u043c\u043c\u0430> <\u0447\u0430\u0441\u043e\u0432> <\u043f\u0440\u0438\u0447\u0438\u043d\u0430>");
            return true;
        }
        ...
        this.plugin.getServer().getScheduler().runTaskAsynchronously((Plugin)this.plugin, () -> {
            ...
            this.plugin.getServer().getScheduler().runTask((Plugin)this.plugin, () -> {
                if (resp.isSuccess()) {
                    ...
                    sender.sendMessage(this.plugin.prefix() + "\u00a7a\u0428\u0442\u0440\u0430\u0444 \u00a7f#" + fineId + " \u00a7a\u0432\u044b\u0434\u0430\u043d \u0438\u0433\u0440\u043e\u043a\u0443 \u00a7f" + targetName + " \u00a7a\u043d\u0430 \u00a7f" + finalAmount + " \u00a7a\u0430\u043b\u043c\u0430\u0437\u043e\u0432. \u0421\u0440\u043e\u043a: \u00a7f" + finalHours + "\u0447.");
                    if (online != null) {
                        online.sendMessage(this.plugin.prefix() + "\u00a7c\u0412\u0430\u043c \u0432\u044b\u0434\u0430\u043d \u0448\u0442\u0440\u0430\u0444 \u00a7f#" + fineId + " \u00a7c\u043d\u0430 \u00a7f" + finalAmount + " \u00a7c\u0430\u043b\u043c\u0430\u0437\u043e\u0432. \u041f\u0440\u0438\u0447\u0438\u043d\u0430: \u00a7f" + reason + "\u00a7c. \u0421\u0440\u043e\u043a: \u00a7f" + finalHours + " \u0447.");
                    }
                } else {
